...
Full profiles for the modelled planets making up the mass-radius curves are available but the files are too large to store on GitHub, see Zenodo repository for these profiles: https://zenodo.org/records/20382154<br/>
Info (M-R Curves):<br/>
